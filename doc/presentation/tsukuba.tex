...
\ifShowHidden
  \begin{frame}{``捻じれ'' がもたらす停滞}
    ...
    \begin{figure}[htbp]
      \centering
      \animategraphics[autoplay,loop,width=0.38\columnwidth]{5}{circle/circle-}{1}{50} %!!!50
    \end{figure}
  \end{frame}
\fi
...
\begin{frame}{貢献2: 初期配置を求める問題の定式化}
  元々の問題は以下であった:
  \begin{mini*}
    {X \in \bbR^{2 \times n}}
  ...
  \begin{columns}
    ...
    \end{column}
  \end{columns}
  次以降でなぜこのように簡略化したのか、これをどう解くかを説明する。\\
\end{frame}

\ifShowHidden
  \begin{frame}{貢献2: 問題の簡略化の理由}
