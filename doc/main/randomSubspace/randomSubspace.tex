...
\begin{tikzpicture}
  ...
  \begin{scope}[shift={(-3,0)}]
    \draw[-{Stealth[length=2mm]}, very thick] (0,0,0) -- (4,0,0) node[anchor=west] {\Large$x$};
    \draw[-{Stealth[length=2mm]}, very thick] (0,0,0) -- (0,4,0) node[anchor=south] {\Large$z$};
    \draw[-{Stealth[length=2mm]}, very thick] (0,0,0) -- (0,0,-4.5) node[anchor=west] {\Large$y$};
    ...
    \draw[-{Stealth[length=2mm]},very thick, cA] (O)--(A);
    \draw[-{Stealth[length=2mm]},very thick, cA] (A)--(B);
    \draw[-{Stealth[length=2mm]},very thick, cA] (B)--(C);
  \end{scope}
  ...
  \begin{scope}[shift={(+3,0)}]
    ...
    \draw[-{Stealth[length=2mm]},very thick, cD] (O)--(A);
    \draw[-{Stealth[length=2mm]},very thick, cD] (A)--(B);
    \draw[-{Stealth[length=2mm]},very thick, cD] (B)--(C);
