...
\begin{figure*}[btp]
    ...
    \begin{tabular}{ccccc}
        ...
        \makecell{\small{\textsf{FR}}                                                                                   \\[-0.2em]\includegraphics[width=0.27\columnwidth]{individual/vis/cycle300_FR.pdf}} &
        \makecell{\small{\textsf{L-BFGS}}                                                                               \\[-0.2em]\includegraphics[width=0.27\columnwidth]{individual/vis/cycle300_L_BFGS.pdf}} &
        ...
        \makecell{\small{\textsf{L-BFGS}}                                                                               \\[-0.2em]\includegraphics[width=0.27\columnwidth]{individual/vis/jagmesh1_L_BFGS.png}} &
        ...
        \makecell{\small{\textsf{L-BFGS}}                                                                               \\[-0.2em]\includegraphics[width=0.27\columnwidth]{individual/vis/dwt_1005_L_BFGS.png}} &
        ...
        \makecell{\small{\textsf{L-BFGS}}                                                                               \\[-0.2em]\includegraphics[width=0.27\columnwidth]{individual/vis/btree9_L_BFGS.png}} &
        ...
        \makecell{\small{\textsf{FR}}                                                                                   \\[-0.2em]\includegraphics[width=0.27\columnwidth]{individual/vis/1138_bus_FR.pdf}} &
        \makecell{\small{\textsf{L-BFGS}}                                                                               \\[-0.2em]\includegraphics[width=0.27\columnwidth]{individual/vis/1138_bus_L_BFGS.pdf}} &
        ...
        \makecell{\small{\textsf{FR}}                                                                                   \\[-0.2em]\includegraphics[width=0.27\columnwidth]{individual/vis/dwt_2680_FR.pdf}} &
        \makecell{\small{\textsf{L-BFGS}}                                                                               \\[-0.2em]\includegraphics[width=0.27\columnwidth]{individual/vis/dwt_2680_L_BFGS.pdf}} &
