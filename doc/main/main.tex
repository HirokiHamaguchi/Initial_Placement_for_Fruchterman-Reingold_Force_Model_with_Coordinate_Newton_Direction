...
\IEEEtitleabstractindextext{%
    \begin{abstract}
        ...
        This layout can be interpreted as a solution of a continuous optimization problem.
        Typically, this problem is solved using the FR algorithm, a gradient descent-like method, or the L-BFGS algorithm, quasi-Newton method.
        ...
        In this paper, to accelerate the optimization process, we propose a new initial placement obtained with subspace newton direction.
        We first reformulate the problem as a discrete optimization problem using a hexagonal lattice, and then iteratively move a randomly selected vertex along the Newton direction defined in the subspace.
...
\begin{figure}[t]
    ...
    \begin{tabular}{cc}
        ...
        \begin{minipage}{0.45\columnwidth}
            \centering
            \includegraphics[width=0.85\columnwidth]{jagmesh1/jagmesh1_CN.png}
        \end{minipage}
                                                                           &
        \begin{minipage}{0.45\columnwidth}
            \centering
            \includegraphics[width=0.85\columnwidth]{jagmesh1/jagmesh1_CN_L_BFGS.png}
        \end{minipage}
    \end{tabular}
...
\begin{figure}[t]
    ...
    \begin{minipage}{0.49\columnwidth}
        \centering
        \includegraphics[width=0.5\columnwidth]{overall/viz/can_187_CN_FR_first.png}
    \end{minipage}
    \begin{minipage}{0.49\columnwidth}
        \centering
        \includegraphics[width=0.5\columnwidth]{overall/viz/can_187_CN_FR_last.png}
    \end{minipage}
...
\begin{figure}[t]
    ...
    \begin{minipage}{0.49\columnwidth}
        \centering
        \includegraphics[width=0.5\columnwidth]{overall/viz/can_73_CN_L_BFGS_first.png}
    \end{minipage}
    \begin{minipage}{0.49\columnwidth}
        \centering
        \includegraphics[width=0.5\columnwidth]{overall/viz/can_73_CN_L_BFGS_last.png}
    \end{minipage}
...
\begin{figure}[t]
    ...
    \begin{minipage}{0.49\columnwidth}
        \centering
        \includegraphics[width=0.5\columnwidth]{overall/viz/iris_dataset_30NN_CN_L_BFGS_first.png}
    \end{minipage}
    \begin{minipage}{0.49\columnwidth}
        \centering
        \includegraphics[width=0.5\columnwidth]{overall/viz/iris_dataset_30NN_CN_L_BFGS_last.png}
    \end{minipage}
...
\begin{figure}[t]
    ...
    \begin{minipage}{0.49\columnwidth}
        \centering
        \includegraphics[width=0.5\columnwidth]{overall/viz/dwt_592_CN_L_BFGS_first.png}
    \end{minipage}
    \begin{minipage}{0.49\columnwidth}
        \centering
        \includegraphics[width=0.5\columnwidth]{overall/viz/dwt_592_CN_L_BFGS_last.png}
    \end{minipage}
...
\begin{figure*}[btp]
    ...
    \begin{tabular}{ccccc}
        ...
        \makecell{\small{\textsf{CN-FR}}                                                                                \\[-0.2em]\includegraphics[width=0.27\columnwidth]{individual/viz/cycle300_CN_FR.pdf}} &
        \makecell{\small{\textsf{CN-L-BFGS}}                                                                            \\[-0.2em]\includegraphics[width=0.27\columnwidth]{individual/viz/cycle300_CN_L_BFGS.pdf}} \\
        ...
        \makecell{\small{\textsf{CN-FR}}                                                                                \\[-0.2em]\includegraphics[width=0.27\columnwidth]{individual/viz/jagmesh1_CN_FR.png}} &
        \makecell{\small{\textsf{CN-L-BFGS}}                                                                            \\[-0.2em]\includegraphics[width=0.27\columnwidth]{individual/viz/jagmesh1_CN_L_BFGS.png}} \\
        ...
        \makecell{\small{\textsf{CN-FR}}                                                                                \\[-0.2em]\includegraphics[width=0.27\columnwidth]{individual/viz/dwt_1005_CN_FR.png}} &
        \makecell{\small{\textsf{CN-L-BFGS}}                                                                            \\[-0.2em]\includegraphics[width=0.27\columnwidth]{individual/viz/dwt_1005_CN_L_BFGS.png}} \\
        ...
        \makecell{\small{\textsf{CN-FR}}                                                                                \\[-0.2em]\includegraphics[width=0.27\columnwidth]{individual/viz/btree9_CN_FR.png}} &
        \makecell{\small{\textsf{CN-L-BFGS}}                                                                            \\[-0.2em]\includegraphics[width=0.27\columnwidth]{individual/viz/btree9_CN_L_BFGS.png}} \\
        ...
        \makecell{\small{\textsf{CN-FR}}                                                                                \\[-0.2em]\includegraphics[width=0.27\columnwidth]{individual/viz/1138_bus_CN_FR.pdf}} &
        \makecell{\small{\textsf{CN-L-BFGS}}                                                                            \\[-0.2em]\includegraphics[width=0.27\columnwidth]{individual/viz/1138_bus_CN_L_BFGS.pdf}} \\
        ...
        \makecell{\small{\textsf{CN-FR}}                                                                                \\[-0.2em]\includegraphics[width=0.27\columnwidth]{individual/viz/dwt_2680_CN_FR.pdf}} &
        \makecell{\small{\textsf{CN-L-BFGS}}                                                                            \\[-0.2em]\includegraphics[width=0.27\columnwidth]{individual/viz/dwt_2680_CN_L_BFGS.pdf}} \\
        ...
        \makecell{\small{\textsf{CN-FR}}                                                                                \\[-0.2em]\includegraphics[width=0.27\columnwidth]{individual/viz/3elt_CN_FR.pdf}} &
        \makecell{\small{\textsf{CN-L-BFGS}}                                                                            \\[-0.2em]\includegraphics[width=0.27\columnwidth]{individual/viz/3elt_CN_L_BFGS.pdf}} \\
    \end{tabular}
