...
\begin{figure}[t]
    ...
    \begin{tikzpicture}[overlay, remember picture]
        \draw[-{Stealth[length=2mm]}, thick] (-0.3,1.4) -- (+0.3,1.4);
    \end{tikzpicture}
    \caption{
...
We tested our algorithm, as well as other conventional methods such as FR algorithm and L-BFGS method, on the following seven graphs:
...
\if0
    \begin{figure*}[t]
        ...
        \begin{tabular}{ccccc}
            \multicolumn{4}{c}{\textbf{btree9}}                                                             \\
            \raisebox{-.5\height}{\includegraphics[width=0.58\columnwidth]{individual/plot/btree9.pdf}}   &
            \makecell{\small{FR}                                                                            \\[-0.2em]\includegraphics[width=0.29\columnwidth]{individual/viz/btree9_FR.png}} &
            \makecell{\small{L\_BFGS}                                                                       \\[-0.2em]\includegraphics[width=0.29\columnwidth]{individual/viz/btree9_L_BFGS.png}} &
            \makecell{\small{RS\_FR}                                                                        \\[-0.2em]\includegraphics[width=0.29\columnwidth]{individual/viz/btree9_RS_FR.png}} &
            \makecell{\small{RS\_L\_BFGS}                                                                   \\[-0.2em]\includegraphics[width=0.29\columnwidth]{individual/viz/btree9_RS_L_BFGS.png}} \\
            \multicolumn{4}{c}{\textbf{dwt\_1005}}                                                          \\
            \raisebox{-.5\height}{\includegraphics[width=0.58\columnwidth]{individual/plot/dwt_1005.pdf}} &
            \makecell{\small{FR}                                                                            \\[-0.2em]\includegraphics[width=0.29\columnwidth]{individual/viz/dwt_1005_FR.png}} &
            \makecell{\small{L\_BFGS}                                                                       \\[-0.2em]\includegraphics[width=0.29\columnwidth]{individual/viz/dwt_1005_L_BFGS.png}} &
            \makecell{\small{RS\_FR}                                                                        \\[-0.2em]\includegraphics[width=0.29\columnwidth]{individual/viz/dwt_1005_RS_FR.png}} &
            \makecell{\small{RS\_L\_BFGS}                                                                   \\[-0.2em]\includegraphics[width=0.29\columnwidth]{individual/viz/dwt_1005_RS_L_BFGS.png}} \\
            \multicolumn{4}{c}{\textbf{cycle300}}                                                           \\
            \raisebox{-.5\height}{\includegraphics[width=0.58\columnwidth]{individual/plot/cycle300.pdf}} &
            \makecell{\small{FR}                                                                            \\[-0.2em]\includegraphics[width=0.29\columnwidth]{individual/viz/cycle300_FR.png}} &
            \makecell{\small{L\_BFGS}                                                                       \\[-0.2em]\includegraphics[width=0.29\columnwidth]{individual/viz/cycle300_L_BFGS.png}} &
            \makecell{\small{RS\_FR}                                                                        \\[-0.2em]\includegraphics[width=0.29\columnwidth]{individual/viz/cycle300_RS_FR.png}} &
            \makecell{\small{RS\_L\_BFGS}                                                                   \\[-0.2em]\includegraphics[width=0.29\columnwidth]{individual/viz/cycle300_RS_L_BFGS.png}} \\
            \multicolumn{4}{c}{\textbf{3elt}}                                                               \\
            \raisebox{-.5\height}{\includegraphics[width=0.58\columnwidth]{individual/plot/3elt.pdf}}     &
            \makecell{\small{FR}                                                                            \\[-0.2em]\includegraphics[width=0.29\columnwidth]{individual/viz/3elt_FR.png}} &
            \makecell{\small{L\_BFGS}                                                                       \\[-0.2em]\includegraphics[width=0.29\columnwidth]{individual/viz/3elt_L_BFGS.png}} &
            \makecell{\small{RS\_FR}                                                                        \\[-0.2em]\includegraphics[width=0.29\columnwidth]{individual/viz/3elt_RS_FR.png}} &
            \makecell{\small{RS\_L\_BFGS}                                                                   \\[-0.2em]\includegraphics[width=0.29\columnwidth]{individual/viz/3elt_RS_L_BFGS.png}} \\
            \multicolumn{4}{c}{\textbf{jagmesh1}}                                                           \\
            \raisebox{-.5\height}{\includegraphics[width=0.58\columnwidth]{individual/plot/jagmesh1.pdf}} &
            \makecell{\small{FR}                                                                            \\[-0.2em]\includegraphics[width=0.29\columnwidth]{individual/viz/jagmesh1_FR.png}} &
            \makecell{\small{L\_BFGS}                                                                       \\[-0.2em]\includegraphics[width=0.29\columnwidth]{individual/viz/jagmesh1_L_BFGS.png}} &
            \makecell{\small{RS\_FR}                                                                        \\[-0.2em]\includegraphics[width=0.29\columnwidth]{individual/viz/jagmesh1_RS_FR.png}} &
            \makecell{\small{RS\_L\_BFGS}                                                                   \\[-0.2em]\includegraphics[width=0.29\columnwidth]{individual/viz/jagmesh1_RS_L_BFGS.png}} \\
            \multicolumn{4}{c}{\textbf{dwt\_2680}}                                                          \\
            \raisebox{-.5\height}{\includegraphics[width=0.58\columnwidth]{individual/plot/dwt_2680.pdf}} &
            \makecell{\small{FR}                                                                            \\[-0.2em]\includegraphics[width=0.29\columnwidth]{individual/viz/dwt_2680_FR.png}} &
            \makecell{\small{L\_BFGS}                                                                       \\[-0.2em]\includegraphics[width=0.29\columnwidth]{individual/viz/dwt_2680_L_BFGS.png}} &
            \makecell{\small{RS\_FR}                                                                        \\[-0.2em]\includegraphics[width=0.29\columnwidth]{individual/viz/dwt_2680_RS_FR.png}} &
            \makecell{\small{RS\_L\_BFGS}                                                                   \\[-0.2em]\includegraphics[width=0.29\columnwidth]{individual/viz/dwt_2680_RS_L_BFGS.png}} \\
            \multicolumn{4}{c}{\textbf{1138\_bus}}                                                          \\
            \raisebox{-.5\height}{\includegraphics[width=0.58\columnwidth]{individual/plot/1138_bus.pdf}} &
            \makecell{\small{FR}                                                                            \\[-0.2em]\includegraphics[width=0.29\columnwidth]{individual/viz/1138_bus_FR.png}} &
            \makecell{\small{L\_BFGS}                                                                       \\[-0.2em]\includegraphics[width=0.29\columnwidth]{individual/viz/1138_bus_L_BFGS.png}} &
            \makecell{\small{RS\_FR}                                                                        \\[-0.2em]\includegraphics[width=0.29\columnwidth]{individual/viz/1138_bus_RS_FR.png}} &
            \makecell{\small{RS\_L\_BFGS}                                                                   \\[-0.2em]\includegraphics[width=0.29\columnwidth]{individual/viz/1138_bus_RS_L_BFGS.png}} \\
        \end{tabular}
