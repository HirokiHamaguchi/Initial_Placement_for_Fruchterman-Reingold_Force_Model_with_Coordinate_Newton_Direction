...
\begin{tikzpicture}
  ...
  \node (A) at (0,+1.0*\y) {\includegraphics[width=3cm]{../individual/vis/fig1_init_random.png}};
  \node[above=0.1cm of A, scale=1.2] {\large{\textsf{random}}};

  \node (B) at (+6, +1.5*\y) {\includegraphics[width=3cm]{../individual/vis/fig1_jagmesh1_FR.png}};

  \node (C) at (+6, +0.5*\y) {\includegraphics[width=3cm]{../individual/vis/fig1_jagmesh1_L-BFGS.png}};

  \node (D) at (0, -1.0*\y) {\includegraphics[width=3cm]{../individual/vis/fig1_init_CN.png}};

  \node (E) at (+6, -0.5*\y) {\includegraphics[width=3cm]{../individual/vis/fig1_jagmesh1_CN-FR.png}};

  \node (F) at (+6, -1.5*\y) {\includegraphics[width=3cm]{../individual/vis/fig1_jagmesh1_CN-L-BFGS.png}};
