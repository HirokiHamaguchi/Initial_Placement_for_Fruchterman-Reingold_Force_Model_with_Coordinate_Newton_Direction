...
\begin{tikzpicture}
  ...
  \node (B) at (+6, +1.5*\y) {\includegraphics[width=3cm]{../individual/vis/jagmesh1_FR.png}};

  \node (C) at (+6, +0.5*\y) {\includegraphics[width=3cm]{../individual/vis/jagmesh1_L-BFGS.png}};

  \node (D) at (0, -1.0*\y) {\includegraphics[width=3cm]{../individual/vis/fig1_init_CN.png}};

  \node (E) at (+6, -0.5*\y) {\includegraphics[width=3cm]{../individual/vis/jagmesh1_CN-FR.png}};

  \node (F) at (+6, -1.5*\y) {\includegraphics[width=3cm]{../individual/vis/jagmesh1_CN-L-BFGS.png}};
