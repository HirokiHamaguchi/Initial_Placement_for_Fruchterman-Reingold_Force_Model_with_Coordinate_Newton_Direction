...
\begin{tikzpicture}
  ...
  \node (A) at (-1.2*\y,0) {\includegraphics[width=3cm]{../individual/vis/fig1_init_random.png}};
  \node[above=0.1cm of A, scale=1.2] {\large{\textsf{random}}};

  \node (B) at (-1.8*\y,-5) {\includegraphics[width=3cm]{../individual/vis/jagmesh1_FR.png}};

  \node (C) at (-0.6*\y,-5) {\includegraphics[width=3cm]{../individual/vis/jagmesh1_L-BFGS.png}};

  \node (D) at (+1.2*\y, 0) {\includegraphics[width=3cm]{../individual/vis/fig1_init_CN.png}};

  \node (E) at (+0.6*\y,-5) {\includegraphics[width=3cm]{../individual/vis/jagmesh1_CN-FR.png}};

  \node (F) at (+1.8*\y,-5) {\includegraphics[width=3cm]{../individual/vis/jagmesh1_CN-L-BFGS.png}};
